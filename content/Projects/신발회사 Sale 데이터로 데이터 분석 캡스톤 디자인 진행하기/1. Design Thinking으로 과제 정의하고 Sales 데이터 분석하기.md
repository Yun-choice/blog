...
---
>[!info] Overview
>2025년 2학기 캡스톤디자인 과정에서 Design Thinkg을 통한 과제 정의와 Sales 데이터로 진행한 EDA 과정을 설명한다.
>데이터 전처리, Kakaomap-api 활용, Folium Gis 분석, 상관관계 분석 방법과 코드를 확인할 수 있다.
>
>**Platform:** Python
...
여기서 [[▣ Python Data Analysis Cheat-Sheet|kakao map api]]를 이용하여 시/도 단위 지역명과 위/경도를 추출합니다.
...
- 다음화 보러가기 : [[2. ARIMA 모델과 Tensorflow로 매출액 예측 모델링하기]]

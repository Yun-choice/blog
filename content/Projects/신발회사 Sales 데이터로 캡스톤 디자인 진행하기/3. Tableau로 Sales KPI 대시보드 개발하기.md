...
3. [[3. Tableau로 Sales KPI 대시보드 개발하기#4) 월별 판매 채널 순위 Bump chart\|4) 월별 판매 채널 순위 Bump chart]]에는 필터 상자에 날짜 변수를 추가하고, 범주형 연도로 설정합니다.
...
4. Region 필터를 추가합니다. ([[3. Tableau로 Sales KPI 대시보드 개발하기#1) 필터링\|필터링]] 단계에서 설정한 '컨텍스트' 필터가 반드시 선행되어야 합니다.)
